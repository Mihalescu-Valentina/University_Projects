...
class TestStudent(unittest.TestCase):
    ...
    def test_grade_service(self):
        ...
        self.assertEqual(self.__service.ungraded_assignments(2),['Assignment_id: 1, Student_id: 2, Grade_value: None'])
        with self.assertRaises(GradeRepositoryException) as context:
        ...
        self.__student_repo.save(Student(20, "vale mih", 917))
        self.__assignment_repo.save_assignment(Assignment(11, "desc", "2021-12-12 23:59"))
        self.assertEqual(self.__service.ungraded_assignment(),[(1, 'name name'), (2, 'name name')])
        self.__service.delete_grade(9,2)
        self.assertEqual(len(self.__service),6)
        self.__service.assign_None(5,2,None)
        #self.assertEqual(self.__service.find_by_ids(5,2),[5,2,None])
